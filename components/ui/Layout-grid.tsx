...
const SelectedCard = ({ selected }: { selected: Card | null }) => {
  return (
    <div className="bg-transparent h-full w-full flex flex-col justify-end items-center rounded-lg shadow-2xl relative z-[60]">
      <motion.div
        initial={{
          opacity: 0,
        }}
      ...
      <motion.div
        ...
        className="relative px-0 md:px-2 pb-4 z-[70] lg:px-8 max-[360px]:w-full"
      >
        {selected?.content}
      </motion.div>
    </div>
